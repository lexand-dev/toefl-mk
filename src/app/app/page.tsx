...
export default async function Dashboard() {
  ...
  return <article><h1>Hola, {actor.name}</h1><p>Tu cuenta está verificada.</p>
    ...
    <nav><Link href="/app/practice">Practicar lectura R3</Link><Link href="/app/history">Historial y actividad</Link>{hasRole(actor, ["editor", "admin"]) && <Link href="/editor">Edición</Link>}
